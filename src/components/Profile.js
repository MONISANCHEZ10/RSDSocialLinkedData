        ...
        return (
            <div>
                ...
                <form onSubmit={this.handleSave}>
                            ...
                            <Grid item xs={12} sm={6}>
                                ...
                                >
                                    {({  onImageUpload }) => (
                                        ...
                                        <div>
                                            <Button onClick={onImageUpload} variant="contained" color="primary" > <WallpaperIcon/> &nbsp; ACTUALIZAR</Button>
                                        </div>
                                    )}
                                </ImageUploading>
                            </Grid>
                    ...
                    <br/><br/>
                    <Grid>
                        <Button  type="submit"  variant="contained" color="primary" size="large"  > <CloudUploadIcon/> &nbsp; GUARDAR</Button>
                    </Grid>
